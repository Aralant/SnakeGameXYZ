...
void Game::Initialize()
{
	...
	_window.setFramerateLimit(60); //Ограничиваем FPS
	_window.setKeyRepeatEnabled(false); //Убираем повторны сигнал, если кнопка зажата.
...
void Game::SwitchToPlayingState()
{
	...
	//Принудительно сбрасываем таймеры если игрок начать игру раньше
	_startTimer.Reset(); 
...
void Game::UpdatePlayingState()
{
	...
	//Проверяем столкновение. Если есть столкновение то выходим
